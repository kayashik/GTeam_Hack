...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ session2;
USE session2;

--
-- Table structure for table `session2`.`aircrafts`
--
...
--
-- Dumping data for table `session2`.`aircrafts`
--
...
--
-- Table structure for table `session2`.`airports`
--
...
--
-- Dumping data for table `session2`.`airports`
--
...
--
-- Table structure for table `session2`.`countries`
--
...
--
-- Dumping data for table `session2`.`countries`
--
...
--
-- Table structure for table `session2`.`offices`
--
...
--
-- Dumping data for table `session2`.`offices`
--
...
--
-- Table structure for table `session2`.`roles`
--
...
--
-- Dumping data for table `session2`.`roles`
--
...
--
-- Table structure for table `session2`.`routes`
--
...
--
-- Dumping data for table `session2`.`routes`
--
...
--
-- Table structure for table `session2`.`schedules`
--
...
--
-- Dumping data for table `session2`.`schedules`
--
...
--
-- Table structure for table `session2`.`users`
--
...
--
-- Dumping data for table `session2`.`users`
--
...
INSERT INTO `users` (`ID`,`RoleID`,`Email`,`Password`,`FirstName`,`LastName`,`OfficeID`,`Birthdate`,`Active`) VALUES 
 ...
 (8,2,'m.osteen@amonic.com','0fbce6c74ff376d18cb352e7fdc6273b','Milagros','Osteen',1,'1991-02-03',1);
